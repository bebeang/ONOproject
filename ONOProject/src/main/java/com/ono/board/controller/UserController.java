...
import com.ono.board.domain.UserCreateFormDto;
...
public class UserController {
	...
	@GetMapping("/signup")
	public String signup(UserCreateFormDto userCreateForm) {
		return "signup_form";
	}

	@PostMapping("/signup")
	public String signup(@Valid UserCreateFormDto userCreateForm, BindingResult bindingResult) {
		...
		try {
			userService.create(userCreateForm.getUsername(), userCreateForm.getPassword1(), userCreateForm.getEmail(),
					userCreateForm.getName(), userCreateForm.getNickname(), userCreateForm.getProfile(),
					userCreateForm.getGender(), userCreateForm.getMobile(), userCreateForm.getZip(),
					userCreateForm.getAddress1(), userCreateForm.getAddress2(), userCreateForm.getBirthday(),
					userCreateForm.getJoindate(), userCreateForm.getRole());
...
//	}
//	
//	@GetMapping("/login/oauth2/authorization/kakao")
